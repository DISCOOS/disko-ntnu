...
public class GeoPos implements Cloneable
{
     ...
     * ===================================================================
     *
     * When converting between GEO representations, the
     * coordinate precision may be reduced. Measurements has shown that the
     * the average increase in error distance per conversion loop is 
     * 8.5E-6 meters (0.0084 millimeter).
     *
    ...
    {
        return GeoUtils.greatCircleDistance(
    ...
    {
        return GeoUtils.sphericalAzimuth(
        		aPos1.m_position.y, aPos1.m_position.x,
        		aPos2.m_position.y, aPos2.m_position.x);
    }
