...
public abstract class AbstractCue<S extends IData> extends AbstractDsObject implements ICue {
	...
	public AbstractCue(IData id, String name, String[] attrNames, Class<?>[] attrClasses) {
		// forward
		super(id);
		// prepare
		m_name = name;
