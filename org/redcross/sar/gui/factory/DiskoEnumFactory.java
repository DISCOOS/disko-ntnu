...
public class DiskoEnumFactory {
	...
	public static String getText(Enum<?> e, String suffix, Object resource) {
		...
		// try get enum text from resource bundle associated with the enums declaring class?
	...
	private static String translate(Enum<?> e, String suffix) {
		...
		// try to get value from resources?
		if(bundle!=null)
	...
	public static String getText(String name, String suffix, Object resource) {
		return getText(name + "." + suffix, resource);
	}
