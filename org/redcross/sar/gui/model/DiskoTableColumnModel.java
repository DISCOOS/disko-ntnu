 ...
 *
 * @version 0.9 04/03/01, edited 10/09/08
 * @author Stephen Kelvin, mail@StephenKelvin.de, edited by Kenneth Gulbrandsøy
 * @see DefaultTableColumnModel
 */

public class DiskoTableColumnModel extends DefaultTableColumnModel {
	 ...
	 * @return table column object or null if no such column in this column model exists
	 */
