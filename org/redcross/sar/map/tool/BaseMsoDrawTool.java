 ...
 *
 */
public class BaseMsoDrawTool extends BaseMsoTool implements IDrawTool {
	 ...
	 */
	public BaseMsoDrawTool(IMsoModelIf model, boolean isRubberInUse,
	...
	class DrawWork extends AbstractToolWork<Boolean> {
		...
		public void afterDone() {
			...
			// notify?
			if(isDone) fireOnWorkFinish(BaseMsoDrawTool.this,msoObject);
	 ...
	 *
	 */
	public class DrawToolState extends BaseMsoTool.MsoToolState {
		...
		// create state
		public DrawToolState(BaseMsoDrawTool tool) {
			super((BaseMsoTool)tool);
			save(tool);
		}

		public void save(BaseMsoDrawTool tool) {
		...
		public void load(BaseMsoDrawTool tool) {
